 ...
 */
import request, { service as system } from '@/utils/axios'
export default {
  getOrganList() {
    return system.get('/projectOrganization/view', { projectId: localStorage.getItem('projectId') })
  },
  // 获取用户可用权限
  getPermissionList() {
  ...
  // 获取公司项目列表
  getCompanyProjectList(body) {
    return request.post('cim6d/system/project/list', body)
  },
  // 获取所属公司详情
  getCompanyInfo() {
