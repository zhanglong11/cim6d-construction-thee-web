  ...
  <div>
    <el-form ref="form" style="width: 600px" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="标准品类" prop="templateId">
        <SelectCategory v-model="form.templateId"></SelectCategory>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button type="primary" :loading="btnSaveLoading" @click="submit">创建</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    async submit() {
      ...
      Api.addIotProduct(this.form).then(res => {
