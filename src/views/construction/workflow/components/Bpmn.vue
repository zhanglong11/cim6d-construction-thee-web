  ...
  <div class="bpm-main is-footer">
    ...
    <div class="footer-btn">
      ...
      <template v-else>
        ...
        <el-button type="primary" :loading="btnSaveLoading" @click="save(0)">保存</el-button>
        <el-button type="primary" :loading="btnSaveSubmitLoading" @click="save(1)">保存并部署</el-button>
      </template>
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      mounted: false,
      downLoadAction: `/cim6d-file${process.env.VUE_APP_BASE_API}/noToken/file/commonFile/download/`,
      action: `/cim6d-file${process.env.VUE_APP_BASE_API}/noToken/file/commonFile/visitor/upload/drag-form`,
      jsonData: {},
      // 自定义表单配置
      basicFields: [
        'input',
