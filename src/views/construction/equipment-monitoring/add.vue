        ...
        <el-row :gutter="20">
          <el-col :md="12">
            <el-form-item label="所属区域" prop="monitorArea">
              <el-select v-model="form.monitorAreaId" class="form-input" clearable placeholder="所属区域">
          ...
          <el-col :md="12">
            <el-form-item label="通道号" prop="channel ">
              <el-input v-model="form.channel" class="form-input" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <el-row :gutter="20">
          ...
          <el-col :md="16">
            <el-form-item label="图片">
              <ImportUpload v-model="form.imageId" :limit="1" />
            </el-form-item>
          </el-col>
          <el-col :md="24">
...
import ImportUpload from './components/ImageUpload'
export default {
  ...
  data() {
    ...
    return {
      ...
      formRules: {
        ...
        monitorAreaId: [{ required: true, message: '请选择监控区域', trigger: 'change' }],
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs['formRef'].validate(async valid => {
        if (valid) {
          this.id ? await Api.updateMonitor(this.form) : await Api.addMonitor(this.form)
