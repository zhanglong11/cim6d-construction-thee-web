...
export default {
  ...
  //材料检验列表
  getInspectList: param =>
    axios.material.post(`materialCheck/list`, {
      projectId: localStorage.getItem('projectId'),
      ...param
    }),
  //材料检验详情
  getInspectInfo: id => axios.material.get(`materialCheck/get/${id}`),
  //材料检验保存到草稿
  getInspectSave: param =>
    axios.material.post(`materialCheck/save`, {
      projectId: localStorage.getItem('projectId'),
      ...param
    }),
  //材料检验保存并提交
  getInspectSaveAndSubmit: param =>
    axios.material.post(`materialCheck/saveAndSubmit`, {
      projectId: localStorage.getItem('projectId'),
      ...param
    }),
  //材料检验删除
  getInspectDelete: param => axios.material.post(`materialCheck/batchDelete`, param),
  //材料检验见证
  getInspectTestify: param => axios.material.post(`materialCheck/witness`, param),
  //材料检验填报
  getInspectFill: param => axios.material.post(`materialCheck/fill`, param)
}
