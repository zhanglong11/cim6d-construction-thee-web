  ...
  <div>
    <div class="tooltips">
      <el-form ref="pageQuery" :model="filterForm" inline>
        ...
        <el-form-item>
          <el-button-group v-if="$hasPower('EquipmentList')">
            <el-button type="primary" icon="el-icon-search" @click="refresh">查询</el-button>
            <el-button icon="el-icon-refresh-left" @click="reset">重置</el-button>
          </el-button-group>
        </el-form-item>
        <el-form-item>
          <el-button v-if="$hasPower('EquipmentAdd')" type="primary" icon="el-icon-plus" @click="toEdit(null)"
            >新建</el-button
          >
          <el-button v-if="$hasPower('EquipmentImportAdd')" type="primary" @click="showImport">导入</el-button>
          <el-button v-if="$hasPower('EquipmentDownloadAdd')" type="primary"
...
export default {
  ...
  methods: {
    ...
    toEdit(id) {
      _.isNil(id)
        ? this.$router.push({ name: `EquipmentAdd` })
        : this.$router.push({ name: `EquipmentEdit`, query: { id } })
    },
    toDetail(id) {
      this.$router.push({ name: `EquipmentDetail`, query: { id } })
    },
    showImport() {
