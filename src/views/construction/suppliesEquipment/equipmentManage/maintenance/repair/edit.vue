<template>
  <div class="container no-padding is-footer">
    ...
    <div class="footer-btn">
      ...
      <el-button size="lg" type="primary" :loading="btnSubmitLoading" @click="submit(null)">保存</el-button>
      <el-button size="lg" type="primary" :loading="btnSaveSubmitLoading" @click="submit(true)">保存并提交</el-button>
    </div>
