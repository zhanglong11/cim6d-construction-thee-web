        ...
        <el-col :span="10">
          <el-form ref="form" :model="form" :rules="rules" label-width="150px" class="form-con">
            ...
            <el-form-item label="时间间隔（天）" prop="intervalDays">
              <InputNumberCommon
                :value="form.thisTime && form.lastTime ? moment(form.thisTime).diff(moment(form.lastTime), 'days') : 0"
                class="form-input"
                disabled
              />
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      form.intervalDays = moment(form.thisTime).diff(form.lastTime, 'days') || 0
