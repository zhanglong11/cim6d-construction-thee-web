<template>
  <div class="main">
    ...
    <footer class="main-footer">
      ...
      <el-button size="normal" :loading="btnSaveLoading" @click="handleSubmit((status = 0))">保存</el-button>
      <el-button type="primary" :loading="btnSaveSubmitLoading" size="normal" @click="handleSubmit((status = 1))"
        >提交</el-button
      >
    </footer>
  </div>
...
<script>
import Api from '../../api/modelVersion'
