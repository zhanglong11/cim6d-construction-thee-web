 ...
 */
export const constructionLogRouter = [
  {
    path: '/constructionLog',
    component: Layout,
    redirect: '/constructionLog/list',
    name: 'ConstructionLog',
    meta: { title: '施工日志', icon: 'el-icon-collection' },
    children: [
      {
        path: 'list',
      ...
      },
      {
        ...
        meta: { title: '新建施工日志', activeMenu: '/constructionLog/list' }
      },
      {
        path: 'listDetail',
        name: 'ConstructionLogDetail',
        hidden: true,
        component: () => import('../constructionLogDetail'),
        meta: { title: '施工日志详情', activeMenu: '/constructionLog/list' }
      }
    ]
  }
]
