    ...
    <div class="common-table">
      <div class="header">
        ...
        <div class="time">
          ...
          ><el-input-number
            ...
            :max="12"
            label="月"
          /><span style="margin: 0 5px">月</span>计量工程量清单
        </div>
        <div class="name">
      ...
      <div class="eng-table">
        <vxe-table ref="table" auto-resize border="full" :data="tableData">
          ...
          <vxe-table-column
            field="asOfLastPeriodEngineeringAmounts"
            title="截止上期计量工程量"
            width="150"
          ></vxe-table-column>
...
export default {
  ...
  methods: {
    ...
    async getDetail() {
      ...
      this.form = { ...res1.data, year: res1.data.yearMonth.split('-')[0], month: res1.data.yearMonth.split('-')[1] }
      let res = await Api.getSubPayAmountAllList({ ...res1.data, recordId: this.id })
    ...
    async save() {
      ...
      await Api.saveSubPayAmount(params)
