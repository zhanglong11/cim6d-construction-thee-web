...
export const healthyRouter = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('../labour-force-list'),
        meta: { title: '劳务人员列表' }
      },
      {
        ...
        hidden: true,
        component: () => import('../labour-force-details'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../vehicle/vehicle-list'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../vehicle/add-vehicle'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../vehicle/vehicle-details'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../vehicle/edit-vehicle-record'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../disinfection-record/disinfection-record-list'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../disinfection-record/add-disinfection-record'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../disinfection-record/disinfection-record-details'),
      ...
      },
      {
        ...
        hidden: true,
        component: () => import('../disinfection-record/edit-disinfection-vehicle-record'),
