  ...
  <div class="no-footer">
    ...
    <template v-if="tabType === 'list'">
      <vxe-table
        ...
        :data="fileList"
        row-id="id"
        :radio-config="{ trigger: 'cell', reserve: true, checkRowKey: radioRowId, checkMethod: checkRadioMethod }"
        @radio-change="radioChange"
      >
        <vxe-table-column type="radio" :resizable="false" width="30" align="left"> </vxe-table-column>
    ...
    <template v-else>
      <el-card class="box-card">
        ...
        <div class="file-card-list">
          <el-checkbox-group :value="radioCardId">
            <div
            ...
            >
              <div class="item-top">
                <div class="card-check" :style="{ display: 'block' }" @click.stop="() => {}">
                  <el-checkbox
                    :key="item.id"
                    :disabled="!!item.isFolder"
                    :label="item.id"
                    @change="radioCardChange(item)"
                  />
                </div>
...
export default {
  name: 'CommonDoc',
  components: { LevelTreeDialog, UploadDialog, RenameDialog, AddDialog, SelectDateRange, PreviewDialog },
  props: {
    typeId: {},
    hasAdd: {
      type: Boolean,
