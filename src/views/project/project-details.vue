<template>
  <div class="is-padding">
    <el-card class="card-item">
      ...
      <div class="content">
        ...
        <el-row class="row" :gutter="20">
          <el-col :md="6"
            >参与类型:
            <span>{{ $getLabelFromArg(`${projectType}_participantType`, details.participantsNature) }}</span>
          </el-col>
          <el-col :md="6"
    ...
    <el-card class="card-item">
      ...
      <el-card v-for="(item, i) in partiesRecordList" :key="i" class="card-item">
        <div slot="header" class="clearfix">
...
import api from '@/views/project/api/parties'
...
export default {
  ...
  data() {
    return {
      ...
      projectId: localStorage.getItem('currentProjectSettingsId'), // 项目id
