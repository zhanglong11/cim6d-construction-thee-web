    ...
    <div class="aa">
      <el-card>
        ...
        >
          ...
          <vxe-table-column field="range" title="数据权限范围" align="left">
            <template #default="{ row }">
              <template v-if="row.type === 2">
                <template v-if="role.directorFlag">
                  <el-radio :value="1" :label="1">所有单位</el-radio>
                </template>
                <template v-else>
                  <el-radio-group v-model="row.rangeType" @change="e => handleRadioChange(e, row)">
                    <el-radio :label="1">所有单位</el-radio>
                    <el-radio v-if="!role.directorFlag" :label="2">本单位</el-radio>
                    <el-radio v-if="!role.directorFlag" :label="3">指定单位</el-radio>
                  </el-radio-group>
