<template>
  <div class="wrap">
    ...
    <div class="right">
      ...
      <div class="chart">
        <WaterElevatorChart :isWater="true" :type="activeType" :chart-data="chartData"></WaterElevatorChart>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getDetail(id) {
      let res = await Api.waterDetail(id)
      this.info = res.data
    },
    changeTab(type) {
    ...
    async getChartData() {
      ...
      let res = await Api.waterList({ deviceId: this.id, timeSpan })
  ...
  .left {
    ...
    .current-wrap {
      ...
      .mask {
        ...
        width: 100%;
        height: 100%;
        background: url('../../newImages/internet/waterElectric/water-cur.png') no-repeat center;
      ...
      .icon {
        width: 20px;
        height: 20px;
        background: url('../../newImages/internet/waterElectric/water-icon.png') no-repeat center;
        background-size: contain;
      }
      .num {
        font-size: 30px;
