...
const LABEL_FILL_COLOR = mainColor
...
const AXIS_WIDTH = 4
/**@type {string} 轴颜色*/
const AXIS_STROKE_STYLE = mainColor
/**@type {string} */
const AXIS_STROKE_STYLE_HOVER = mainColor
...
/**@type {string} 刻度颜色*/
const TICK_STROKE_STYLE = mainColor
