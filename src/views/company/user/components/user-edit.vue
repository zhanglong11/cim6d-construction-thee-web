          ...
          <el-form-item prop="headImage" label="头像：">
            <div class="formInput">
              ...
              <avatar-cropper
                ...
                :upload-url="`/cim6d-file${runProcess}/file/commonFile/uploadImage`"
                :output-options="{ width: 200, height: 200 }"
                @uploaded="handleUploaded"
              />
            </div>
          </el-form-item>
          <el-form-item v-if="processEnv === 'development'" label="用户名：" prop="loginName">
...
import Api from '@/views/company/api/departmentUser'
