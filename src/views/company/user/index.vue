  ...
  <div class="main">
    <el-card>
        ...
        <el-form inline>
          ...
          <div>
            <el-button
              ...
              >新建员工</el-button
            >
            <el-button v-if="$hasPower('SystemUserChangeAdmin')" type="primary" @click="changeAdminDialogVisible = true"
              >变更管理员</el-button
            >
            <!--            <el-button
      ...
      >
        ...
        <vxe-table-column v-if="processEnv === 'development'" title="用户名" field="loginName" width="200px" />
...
export default {
  ...
  methods: {
    ...
    remove(rows) {
      this.$remove(idList => {
        return this.axios.system.post('cim6d/system/user/batchDelete', idList)
      }, rows, 'realName').then(res => this.refresh())
    },
    // 选择人员
