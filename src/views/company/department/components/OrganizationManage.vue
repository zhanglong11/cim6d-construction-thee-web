  ...
  <div>
    ...
    <div style="height: calc(100vh - 300px)">
      ...
      >
        ...
        <vxe-table-column v-if="$hasPower('SystemDepartmentEdit')" field="date" title="编辑">
          <template slot-scope="{ row }">
            <span><a @click="handleEditRow(row)">编辑</a></span>
          </template>
        </vxe-table-column>
      </vxe-table>
    </div>
...
import Api from '@/views/company/api/department'
