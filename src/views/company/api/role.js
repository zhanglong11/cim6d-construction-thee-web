...
export const roleApi = {
  ...
  getSourcePower: data => {
    return http.system({
      url: '/projectRole/companyPower/get',
      method: 'get',
      data: {
        serviceCode: 'base',
        ...data
  ...
  resetRoleBind: (roleId, serviceId) => {
    return http.system({
      url: `cim6d/system/permission/user/role/power/reset/${roleId}/${serviceId}`,
      method: 'get'
    })
  },
  getDataPower: roleId => {
  ...
  getCompanyList: (data, projectId) => {
    return http.system({
      url: 'projectOrganization/participant/companyList',
      method: 'post',
      headers: {
